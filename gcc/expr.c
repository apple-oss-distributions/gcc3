...
init_expr ()
{
  ...
  cfun->expr = (struct expr_status *) 
  	       PFE_MALLOC (sizeof (struct expr_status), PFE_ALLOC_EXPR_STATUS);
...
/* PPC/Darwin requires that we generate regs for pushing constants here.  */
#ifndef ALWAYS_PUSH_CONSTS_USING_REGS_P
#define ALWAYS_PUSH_CONSTS_USING_REGS_P	0	/* for most targets  */
#endif
