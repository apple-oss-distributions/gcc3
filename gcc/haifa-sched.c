...
/* APPLE LOCAL, a temporary kludge */
#if 1 && MAX_MULTIPLICITY > 1
  {
   /* decrease the priority of single-cycle instructions that can go on 
	any of several functional units; these are less likely to lead to a stall */
