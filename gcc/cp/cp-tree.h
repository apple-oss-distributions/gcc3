...
extern tree build_vfn_ref_using_vtable          PARAMS ((tree, tree, tree));
...
/* APPLE LOCAL PFE */
#ifdef PFE
extern void pfe_cxx_init_decl_processing	PARAMS ((void));
#endif
/* APPLE LOCAL begin Objective-C++ */
extern tree grokparms				PARAMS ((tree));
extern void store_parm_decls 			PARAMS ((tree));
...
/* APPLE LOCAL Objective-C++ */
extern HOST_WIDE_INT cxx_get_alias_set 		PARAMS ((tree));
...
/* APPLE LOCAL Objective-C++ */
extern void cxx_finish_file			PARAMS ((void));
...
/* APPLE LOCAL PFE */
#ifdef PFE
extern void pfe_init_exception_processing	PARAMS ((void));
#endif
...
/* APPLE LOCAL Objective-C++  */
extern void cxx_init_options PARAMS ((enum c_language_kind));
