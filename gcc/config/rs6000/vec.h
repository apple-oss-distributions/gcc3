static struct builtin B1_vec_abs = { { &T_vec_f32, NULL, NULL, }, "x", &T_vec_f32, 1, FALSE, FALSE, 11, "vec_abs:1", "4", CODE_FOR_xfx_perm, B_UID(0), NULL };
static struct builtin B2_vec_abs = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 11, "vec_abs:2", "2", CODE_FOR_xfx_perm, B_UID(1), NULL };
static struct builtin B3_vec_abs = { { &T_vec_s32, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 11, "vec_abs:3", "3", CODE_FOR_xfx_perm, B_UID(2), NULL };
static struct builtin B4_vec_abs = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s8, 1, FALSE, FALSE, 11, "vec_abs:4", "1", CODE_FOR_xfx_perm, B_UID(3), NULL };
static struct builtin B1_vec_abss = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 11, "vec_abss:1", "6", CODE_FOR_xfx_perm, B_UID(4), NULL };
static struct builtin B2_vec_abss = { { &T_vec_s32, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 11, "vec_abss:2", "7", CODE_FOR_xfx_perm, B_UID(5), NULL };
static struct builtin B3_vec_abss = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s8, 1, FALSE, FALSE, 11, "vec_abss:3", "5", CODE_FOR_xfx_perm, B_UID(6), NULL };
...
static struct builtin B_vec_cmple = { { &T_vec_f32, &T_vec_f32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 10, "vec_cmple", "*vcmpgefp", CODE_FOR_xfxx_simple, B_UID(374), NULL };
static struct builtin B1_vec_cmplt = { { &T_vec_f32, &T_vec_f32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 10, "vec_cmplt:1", "*vcmpgtfp", CODE_FOR_xfxx_simple, B_UID(375), NULL };
static struct builtin B2_vec_cmplt = { { &T_vec_s16, &T_vec_s16, NULL, }, "xx", &T_vec_b16, 2, FALSE, FALSE, 10, "vec_cmplt:2", "*vcmpgtsh", CODE_FOR_xfxx_simple, B_UID(376), NULL };
static struct builtin B3_vec_cmplt = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 10, "vec_cmplt:3", "*vcmpgtsw", CODE_FOR_xfxx_simple, B_UID(377), NULL };
static struct builtin B4_vec_cmplt = { { &T_vec_s8, &T_vec_s8, NULL, }, "xx", &T_vec_b8, 2, FALSE, FALSE, 10, "vec_cmplt:4", "*vcmpgtsb", CODE_FOR_xfxx_simple, B_UID(378), NULL };
static struct builtin B5_vec_cmplt = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_b16, 2, FALSE, FALSE, 10, "vec_cmplt:5", "*vcmpgtuh", CODE_FOR_xfxx_simple, B_UID(379), NULL };
static struct builtin B6_vec_cmplt = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 10, "vec_cmplt:6", "*vcmpgtuw", CODE_FOR_xfxx_simple, B_UID(380), NULL };
static struct builtin B7_vec_cmplt = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_b8, 2, FALSE, FALSE, 10, "vec_cmplt:7", "*vcmpgtub", CODE_FOR_xfxx_simple, B_UID(381), NULL };
...
static struct builtin B_vec_dss = { { &T_immed_u2, NULL, NULL, }, "D", &T_volatile_void, 1, FALSE, FALSE, 0, "vec_dss", "*dss", CODE_FOR_vlfD_load, B_UID(386), NULL };
static struct builtin B_vec_dssall = { { NULL, NULL, NULL, }, "", &T_volatile_void, 0, FALSE, FALSE, 0, "vec_dssall", "*dssall", CODE_FOR_vlf_load, B_UID(387), NULL };
...
static struct builtin B1_vec_unpack2sh = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_unpack2sh:1", "*vmrghh", CODE_FOR_xfxx_perm, B_UID(946), NULL };
static struct builtin B2_vec_unpack2sh = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 0, "vec_unpack2sh:2", "*vmrghb", CODE_FOR_xfxx_perm, B_UID(947), NULL };
static struct builtin B1_vec_unpack2sl = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_unpack2sl:1", "*vmrglh", CODE_FOR_xfxx_perm, B_UID(948), NULL };
static struct builtin B2_vec_unpack2sl = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 0, "vec_unpack2sl:2", "*vmrglb", CODE_FOR_xfxx_perm, B_UID(949), NULL };
static struct builtin B1_vec_unpack2uh = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_unpack2uh:1", "*vmrghh", CODE_FOR_xfxx_perm, B_UID(950), NULL };
static struct builtin B2_vec_unpack2uh = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 0, "vec_unpack2uh:2", "*vmrghb", CODE_FOR_xfxx_perm, B_UID(951), NULL };
static struct builtin B1_vec_unpack2ul = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_unpack2ul:1", "*vmrglh", CODE_FOR_xfxx_perm, B_UID(952), NULL };
static struct builtin B2_vec_unpack2ul = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 0, "vec_unpack2ul:2", "*vmrglb", CODE_FOR_xfxx_perm, B_UID(953), NULL };
static struct builtin B1_vec_vupkhsh = { { &T_vec_b16, NULL, NULL, }, "x", &T_vec_b32, 1, FALSE, FALSE, 0, "vec_vupkhsh:1", "*vupkhsh", CODE_FOR_xfx_perm, B_UID(954), NULL };
static struct builtin B1_vec_vupkhsb = { { &T_vec_b8, NULL, NULL, }, "x", &T_vec_b16, 1, FALSE, FALSE, 0, "vec_vupkhsb:1", "*vupkhsb", CODE_FOR_xfx_perm, B_UID(955), NULL };
static struct builtin B_vec_vupkhpx = { { &T_vec_p16, NULL, NULL, }, "x", &T_vec_u32, 1, FALSE, FALSE, 0, "vec_vupkhpx", "*vupkhpx", CODE_FOR_xfx_perm, B_UID(956), NULL };
static struct builtin B2_vec_vupkhsh = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 0, "vec_vupkhsh:2", "*vupkhsh", CODE_FOR_xfx_perm, B_UID(957), NULL };
static struct builtin B2_vec_vupkhsb = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 0, "vec_vupkhsb:2", "*vupkhsb", CODE_FOR_xfx_perm, B_UID(958), NULL };
static struct builtin B1_vec_vupklsh = { { &T_vec_b16, NULL, NULL, }, "x", &T_vec_b32, 1, FALSE, FALSE, 0, "vec_vupklsh:1", "*vupklsh", CODE_FOR_xfx_perm, B_UID(959), NULL };
static struct builtin B1_vec_vupklsb = { { &T_vec_b8, NULL, NULL, }, "x", &T_vec_b16, 1, FALSE, FALSE, 0, "vec_vupklsb:1", "*vupklsb", CODE_FOR_xfx_perm, B_UID(960), NULL };
static struct builtin B_vec_vupklpx = { { &T_vec_p16, NULL, NULL, }, "x", &T_vec_u32, 1, FALSE, FALSE, 0, "vec_vupklpx", "*vupklpx", CODE_FOR_xfx_perm, B_UID(961), NULL };
static struct builtin B2_vec_vupklsh = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 0, "vec_vupklsh:2", "*vupklsh", CODE_FOR_xfx_perm, B_UID(962), NULL };
static struct builtin B2_vec_vupklsb = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 0, "vec_vupklsb:2", "*vupklsb", CODE_FOR_xfx_perm, B_UID(963), NULL };
static struct builtin B1_vec_vxor = { { &T_vec_b16, &T_vec_b16, NULL, }, "xx", &T_vec_b16, 2, FALSE, FALSE, 1, "vec_vxor:1", "*vxor", CODE_FOR_xfxx_simple, B_UID(964), NULL };
static struct builtin B2_vec_vxor = { { &T_vec_b16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:2", "*vxor", CODE_FOR_xfxx_simple, B_UID(965), NULL };
static struct builtin B3_vec_vxor = { { &T_vec_b16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:3", "*vxor", CODE_FOR_xfxx_simple, B_UID(966), NULL };
static struct builtin B4_vec_vxor = { { &T_vec_b32, &T_vec_b32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 1, "vec_vxor:4", "*vxor", CODE_FOR_xfxx_simple, B_UID(967), NULL };
static struct builtin B5_vec_vxor = { { &T_vec_b32, &T_vec_f32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:5", "*vxor", CODE_FOR_xfxx_simple, B_UID(968), NULL };
static struct builtin B6_vec_vxor = { { &T_vec_b32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:6", "*vxor", CODE_FOR_xfxx_simple, B_UID(969), NULL };
static struct builtin B7_vec_vxor = { { &T_vec_b32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:7", "*vxor", CODE_FOR_xfxx_simple, B_UID(970), NULL };
static struct builtin B8_vec_vxor = { { &T_vec_b8, &T_vec_b8, NULL, }, "xx", &T_vec_b8, 2, FALSE, FALSE, 1, "vec_vxor:8", "*vxor", CODE_FOR_xfxx_simple, B_UID(971), NULL };
static struct builtin B9_vec_vxor = { { &T_vec_b8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:9", "*vxor", CODE_FOR_xfxx_simple, B_UID(972), NULL };
static struct builtin B10_vec_vxor = { { &T_vec_b8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:10", "*vxor", CODE_FOR_xfxx_simple, B_UID(973), NULL };
static struct builtin B11_vec_vxor = { { &T_vec_f32, &T_vec_b32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:11", "*vxor", CODE_FOR_xfxx_simple, B_UID(974), NULL };
static struct builtin B12_vec_vxor = { { &T_vec_f32, &T_vec_f32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:12", "*vxor", CODE_FOR_xfxx_simple, B_UID(975), NULL };
static struct builtin B13_vec_vxor = { { &T_vec_s16, &T_vec_b16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:13", "*vxor", CODE_FOR_xfxx_simple, B_UID(976), NULL };
static struct builtin B14_vec_vxor = { { &T_vec_s16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:14", "*vxor", CODE_FOR_xfxx_simple, B_UID(977), NULL };
static struct builtin B15_vec_vxor = { { &T_vec_s32, &T_vec_b32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:15", "*vxor", CODE_FOR_xfxx_simple, B_UID(978), NULL };
static struct builtin B16_vec_vxor = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:16", "*vxor", CODE_FOR_xfxx_simple, B_UID(979), NULL };
static struct builtin B17_vec_vxor = { { &T_vec_s8, &T_vec_b8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:17", "*vxor", CODE_FOR_xfxx_simple, B_UID(980), NULL };
static struct builtin B18_vec_vxor = { { &T_vec_s8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:18", "*vxor", CODE_FOR_xfxx_simple, B_UID(981), NULL };
static struct builtin B19_vec_vxor = { { &T_vec_u16, &T_vec_b16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:19", "*vxor", CODE_FOR_xfxx_simple, B_UID(982), NULL };
static struct builtin B20_vec_vxor = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:20", "*vxor", CODE_FOR_xfxx_simple, B_UID(983), NULL };
static struct builtin B21_vec_vxor = { { &T_vec_u32, &T_vec_b32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:21", "*vxor", CODE_FOR_xfxx_simple, B_UID(984), NULL };
static struct builtin B22_vec_vxor = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:22", "*vxor", CODE_FOR_xfxx_simple, B_UID(985), NULL };
static struct builtin B23_vec_vxor = { { &T_vec_u8, &T_vec_b8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:23", "*vxor", CODE_FOR_xfxx_simple, B_UID(986), NULL };
static struct builtin B24_vec_vxor = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:24", "*vxor", CODE_FOR_xfxx_simple, B_UID(987), NULL };
#define LAST_B_UID B_UID(988)
...
static struct builtin *O_vec_unpack2sh[2] = {
  &B1_vec_unpack2sh,
  &B2_vec_unpack2sh,
};
static struct builtin *O_vec_unpack2sl[2] = {
  &B1_vec_unpack2sl,
  &B2_vec_unpack2sl,
};
static struct builtin *O_vec_unpack2uh[2] = {
  &B1_vec_unpack2uh,
  &B2_vec_unpack2uh,
};
static struct builtin *O_vec_unpack2ul[2] = {
  &B1_vec_unpack2ul,
  &B2_vec_unpack2ul,
};
...
struct overloadx Overload[] = {
  ...
  { "vec_unpack2sh", 2, 2, O_vec_unpack2sh, O_UID(120), NULL },
  { "vec_unpack2sl", 2, 2, O_vec_unpack2sl, O_UID(121), NULL },
  { "vec_unpack2uh", 2, 2, O_vec_unpack2uh, O_UID(122), NULL },
  { "vec_unpack2ul", 2, 2, O_vec_unpack2ul, O_UID(123), NULL },
  { "vec_unpackh", 5, 1, O_vec_unpackh, O_UID(124), NULL },
  { "vec_unpackl", 5, 1, O_vec_unpackl, O_UID(125), NULL },
  { "vec_vaddcuw", 1, 2, O_vec_vaddcuw, O_UID(126), NULL },
  { "vec_vaddfp", 1, 2, O_vec_vaddfp, O_UID(127), NULL },
  { "vec_vaddsbs", 3, 2, O_vec_vaddsbs, O_UID(128), NULL },
  { "vec_vaddshs", 3, 2, O_vec_vaddshs, O_UID(129), NULL },
  { "vec_vaddsws", 3, 2, O_vec_vaddsws, O_UID(130), NULL },
  { "vec_vaddubm", 6, 2, O_vec_vaddubm, O_UID(131), NULL },
  { "vec_vaddubs", 3, 2, O_vec_vaddubs, O_UID(132), NULL },
  { "vec_vadduhm", 6, 2, O_vec_vadduhm, O_UID(133), NULL },
  { "vec_vadduhs", 3, 2, O_vec_vadduhs, O_UID(134), NULL },
  { "vec_vadduwm", 6, 2, O_vec_vadduwm, O_UID(135), NULL },
  { "vec_vadduws", 3, 2, O_vec_vadduws, O_UID(136), NULL },
  { "vec_vand", 24, 2, O_vec_vand, O_UID(137), NULL },
  { "vec_vandc", 24, 2, O_vec_vandc, O_UID(138), NULL },
  { "vec_vavgsb", 1, 2, O_vec_vavgsb, O_UID(139), NULL },
  { "vec_vavgsh", 1, 2, O_vec_vavgsh, O_UID(140), NULL },
  { "vec_vavgsw", 1, 2, O_vec_vavgsw, O_UID(141), NULL },
  { "vec_vavgub", 1, 2, O_vec_vavgub, O_UID(142), NULL },
  { "vec_vavguh", 1, 2, O_vec_vavguh, O_UID(143), NULL },
  { "vec_vavguw", 1, 2, O_vec_vavguw, O_UID(144), NULL },
  { "vec_vcfsx", 1, 2, O_vec_vcfsx, O_UID(145), NULL },
  { "vec_vcfux", 1, 2, O_vec_vcfux, O_UID(146), NULL },
  { "vec_vcmpbfp", 1, 2, O_vec_vcmpbfp, O_UID(147), NULL },
  { "vec_vcmpeqfp", 1, 2, O_vec_vcmpeqfp, O_UID(148), NULL },
  { "vec_vcmpequb", 2, 2, O_vec_vcmpequb, O_UID(149), NULL },
  { "vec_vcmpequh", 2, 2, O_vec_vcmpequh, O_UID(150), NULL },
  { "vec_vcmpequw", 2, 2, O_vec_vcmpequw, O_UID(151), NULL },
  { "vec_vcmpgefp", 1, 2, O_vec_vcmpgefp, O_UID(152), NULL },
  { "vec_vcmpgtfp", 1, 2, O_vec_vcmpgtfp, O_UID(153), NULL },
  { "vec_vcmpgtsb", 1, 2, O_vec_vcmpgtsb, O_UID(154), NULL },
  { "vec_vcmpgtsh", 1, 2, O_vec_vcmpgtsh, O_UID(155), NULL },
  { "vec_vcmpgtsw", 1, 2, O_vec_vcmpgtsw, O_UID(156), NULL },
  { "vec_vcmpgtub", 1, 2, O_vec_vcmpgtub, O_UID(157), NULL },
  { "vec_vcmpgtuh", 1, 2, O_vec_vcmpgtuh, O_UID(158), NULL },
  { "vec_vcmpgtuw", 1, 2, O_vec_vcmpgtuw, O_UID(159), NULL },
  { "vec_vctsxs", 1, 2, O_vec_vctsxs, O_UID(160), NULL },
  { "vec_vctuxs", 1, 2, O_vec_vctuxs, O_UID(161), NULL },
  { "vec_vexptefp", 1, 1, O_vec_vexptefp, O_UID(162), NULL },
  { "vec_vlogefp", 1, 1, O_vec_vlogefp, O_UID(163), NULL },
  { "vec_vmaddfp", 1, 3, O_vec_vmaddfp, O_UID(164), NULL },
  { "vec_vmaxfp", 1, 2, O_vec_vmaxfp, O_UID(165), NULL },
  { "vec_vmaxsb", 3, 2, O_vec_vmaxsb, O_UID(166), NULL },
  { "vec_vmaxsh", 3, 2, O_vec_vmaxsh, O_UID(167), NULL },
  { "vec_vmaxsw", 3, 2, O_vec_vmaxsw, O_UID(168), NULL },
  { "vec_vmaxub", 3, 2, O_vec_vmaxub, O_UID(169), NULL },
  { "vec_vmaxuh", 3, 2, O_vec_vmaxuh, O_UID(170), NULL },
  { "vec_vmaxuw", 3, 2, O_vec_vmaxuw, O_UID(171), NULL },
  { "vec_vmhaddshs", 1, 3, O_vec_vmhaddshs, O_UID(172), NULL },
  { "vec_vmhraddshs", 1, 3, O_vec_vmhraddshs, O_UID(173), NULL },
  { "vec_vminfp", 1, 2, O_vec_vminfp, O_UID(174), NULL },
  { "vec_vminsb", 3, 2, O_vec_vminsb, O_UID(175), NULL },
  { "vec_vminsh", 3, 2, O_vec_vminsh, O_UID(176), NULL },
  { "vec_vminsw", 3, 2, O_vec_vminsw, O_UID(177), NULL },
  { "vec_vminub", 3, 2, O_vec_vminub, O_UID(178), NULL },
  { "vec_vminuh", 3, 2, O_vec_vminuh, O_UID(179), NULL },
  { "vec_vminuw", 3, 2, O_vec_vminuw, O_UID(180), NULL },
  { "vec_vmladduhm", 4, 3, O_vec_vmladduhm, O_UID(181), NULL },
  { "vec_vmrghb", 3, 2, O_vec_vmrghb, O_UID(182), NULL },
  { "vec_vmrghh", 4, 2, O_vec_vmrghh, O_UID(183), NULL },
  { "vec_vmrghw", 4, 2, O_vec_vmrghw, O_UID(184), NULL },
  { "vec_vmrglb", 3, 2, O_vec_vmrglb, O_UID(185), NULL },
  { "vec_vmrglh", 4, 2, O_vec_vmrglh, O_UID(186), NULL },
  { "vec_vmrglw", 4, 2, O_vec_vmrglw, O_UID(187), NULL },
  { "vec_vmsummbm", 1, 3, O_vec_vmsummbm, O_UID(188), NULL },
  { "vec_vmsumshm", 1, 3, O_vec_vmsumshm, O_UID(189), NULL },
  { "vec_vmsumshs", 1, 3, O_vec_vmsumshs, O_UID(190), NULL },
  { "vec_vmsumubm", 1, 3, O_vec_vmsumubm, O_UID(191), NULL },
  { "vec_vmsumuhm", 1, 3, O_vec_vmsumuhm, O_UID(192), NULL },
  { "vec_vmsumuhs", 1, 3, O_vec_vmsumuhs, O_UID(193), NULL },
  { "vec_vmulesb", 1, 2, O_vec_vmulesb, O_UID(194), NULL },
  { "vec_vmulesh", 1, 2, O_vec_vmulesh, O_UID(195), NULL },
  { "vec_vmuleub", 1, 2, O_vec_vmuleub, O_UID(196), NULL },
  { "vec_vmuleuh", 1, 2, O_vec_vmuleuh, O_UID(197), NULL },
  { "vec_vmulosb", 1, 2, O_vec_vmulosb, O_UID(198), NULL },
  { "vec_vmulosh", 1, 2, O_vec_vmulosh, O_UID(199), NULL },
  { "vec_vmuloub", 1, 2, O_vec_vmuloub, O_UID(200), NULL },
  { "vec_vmulouh", 1, 2, O_vec_vmulouh, O_UID(201), NULL },
  { "vec_vnmsubfp", 1, 3, O_vec_vnmsubfp, O_UID(202), NULL },
  { "vec_vnor", 10, 2, O_vec_vnor, O_UID(203), NULL },
  { "vec_vor", 24, 2, O_vec_vor, O_UID(204), NULL },
  { "vec_vperm", 11, 3, O_vec_vperm, O_UID(205), NULL },
  { "vec_vpkpx", 1, 2, O_vec_vpkpx, O_UID(206), NULL },
  { "vec_vpkshss", 1, 2, O_vec_vpkshss, O_UID(207), NULL },
  { "vec_vpkshus", 1, 2, O_vec_vpkshus, O_UID(208), NULL },
  { "vec_vpkswss", 1, 2, O_vec_vpkswss, O_UID(209), NULL },
  { "vec_vpkswus", 1, 2, O_vec_vpkswus, O_UID(210), NULL },
  { "vec_vpkuhum", 3, 2, O_vec_vpkuhum, O_UID(211), NULL },
  { "vec_vpkuhus", 1, 2, O_vec_vpkuhus, O_UID(212), NULL },
  { "vec_vpkuwum", 3, 2, O_vec_vpkuwum, O_UID(213), NULL },
  { "vec_vpkuwus", 1, 2, O_vec_vpkuwus, O_UID(214), NULL },
  { "vec_vrefp", 1, 1, O_vec_vrefp, O_UID(215), NULL },
  { "vec_vrfim", 1, 1, O_vec_vrfim, O_UID(216), NULL },
  { "vec_vrfin", 1, 1, O_vec_vrfin, O_UID(217), NULL },
  { "vec_vrfip", 1, 1, O_vec_vrfip, O_UID(218), NULL },
  { "vec_vrfiz", 1, 1, O_vec_vrfiz, O_UID(219), NULL },
  { "vec_vrlb", 2, 2, O_vec_vrlb, O_UID(220), NULL },
  { "vec_vrlh", 2, 2, O_vec_vrlh, O_UID(221), NULL },
  { "vec_vrlw", 2, 2, O_vec_vrlw, O_UID(222), NULL },
  { "vec_vrsqrtefp", 1, 1, O_vec_vrsqrtefp, O_UID(223), NULL },
  { "vec_vsel", 20, 3, O_vec_vsel, O_UID(224), NULL },
  { "vec_vsl", 30, 2, O_vec_vsl, O_UID(225), NULL },
  { "vec_vslb", 2, 2, O_vec_vslb, O_UID(226), NULL },
  { "vec_vsldoi", 8, 3, O_vec_vsldoi, O_UID(227), NULL },
  { "vec_vslh", 2, 2, O_vec_vslh, O_UID(228), NULL },
  { "vec_vslo", 16, 2, O_vec_vslo, O_UID(229), NULL },
  { "vec_vslw", 2, 2, O_vec_vslw, O_UID(230), NULL },
  { "vec_vspltb", 3, 2, O_vec_vspltb, O_UID(231), NULL },
  { "vec_vsplth", 4, 2, O_vec_vsplth, O_UID(232), NULL },
  { "vec_vspltisb", 1, 1, O_vec_vspltisb, O_UID(233), NULL },
  { "vec_vspltish", 1, 1, O_vec_vspltish, O_UID(234), NULL },
  { "vec_vspltisw", 1, 1, O_vec_vspltisw, O_UID(235), NULL },
  { "vec_vspltw", 4, 2, O_vec_vspltw, O_UID(236), NULL },
  { "vec_vsr", 30, 2, O_vec_vsr, O_UID(237), NULL },
  { "vec_vsrab", 2, 2, O_vec_vsrab, O_UID(238), NULL },
  { "vec_vsrah", 2, 2, O_vec_vsrah, O_UID(239), NULL },
  { "vec_vsraw", 2, 2, O_vec_vsraw, O_UID(240), NULL },
  { "vec_vsrb", 2, 2, O_vec_vsrb, O_UID(241), NULL },
  { "vec_vsrh", 2, 2, O_vec_vsrh, O_UID(242), NULL },
  { "vec_vsro", 16, 2, O_vec_vsro, O_UID(243), NULL },
  { "vec_vsrw", 2, 2, O_vec_vsrw, O_UID(244), NULL },
  { "vec_vsubcuw", 1, 2, O_vec_vsubcuw, O_UID(245), NULL },
  { "vec_vsubfp", 1, 2, O_vec_vsubfp, O_UID(246), NULL },
  { "vec_vsubsbs", 3, 2, O_vec_vsubsbs, O_UID(247), NULL },
  { "vec_vsubshs", 3, 2, O_vec_vsubshs, O_UID(248), NULL },
  { "vec_vsubsws", 3, 2, O_vec_vsubsws, O_UID(249), NULL },
  { "vec_vsububm", 6, 2, O_vec_vsububm, O_UID(250), NULL },
  { "vec_vsububs", 3, 2, O_vec_vsububs, O_UID(251), NULL },
  { "vec_vsubuhm", 6, 2, O_vec_vsubuhm, O_UID(252), NULL },
  { "vec_vsubuhs", 3, 2, O_vec_vsubuhs, O_UID(253), NULL },
  { "vec_vsubuwm", 6, 2, O_vec_vsubuwm, O_UID(254), NULL },
  { "vec_vsubuws", 3, 2, O_vec_vsubuws, O_UID(255), NULL },
  { "vec_vsum2sws", 1, 2, O_vec_vsum2sws, O_UID(256), NULL },
  { "vec_vsum4sbs", 1, 2, O_vec_vsum4sbs, O_UID(257), NULL },
  { "vec_vsum4shs", 1, 2, O_vec_vsum4shs, O_UID(258), NULL },
  { "vec_vsum4ubs", 1, 2, O_vec_vsum4ubs, O_UID(259), NULL },
  { "vec_vsumsws", 1, 2, O_vec_vsumsws, O_UID(260), NULL },
  { "vec_vupkhpx", 1, 1, O_vec_vupkhpx, O_UID(261), NULL },
  { "vec_vupkhsb", 2, 1, O_vec_vupkhsb, O_UID(262), NULL },
  { "vec_vupkhsh", 2, 1, O_vec_vupkhsh, O_UID(263), NULL },
  { "vec_vupklpx", 1, 1, O_vec_vupklpx, O_UID(264), NULL },
  { "vec_vupklsb", 2, 1, O_vec_vupklsb, O_UID(265), NULL },
  { "vec_vupklsh", 2, 1, O_vec_vupklsh, O_UID(266), NULL },
  { "vec_vxor", 24, 2, O_vec_vxor, O_UID(267), NULL },
  { "vec_xor", 24, 2, O_vec_xor, O_UID(268), NULL },
