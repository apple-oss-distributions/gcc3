...
(define_insn "*movsf_hardfloat2"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=f,m")
	(match_operand:SI 1 "input_operand" "m,f"))]
  "TARGET_HARD_FLOAT
...
;; APPLE LOCAL CCUNS, CCFP, CCEQ patterns
...
(define_insn ""
  [(set (match_operand:CCUNS 0 "nonimmediate_operand" "=y,x,y,r,r,r,r,m")
	(match_operand:CCUNS 1 "nonimmediate_operand" "y,r,r,x,y,r,m,r"))]
...
(define_insn ""
  [(set (match_operand:CCFP 0 "nonimmediate_operand" "=y,x,y,r,r,r,r,m")
	(match_operand:CCFP 1 "nonimmediate_operand" "y,r,r,x,y,r,m,r"))]
...
(define_insn ""
  [(set (match_operand:CCEQ 0 "nonimmediate_operand" "=y,x,y,r,r,r,r,m")
	(match_operand:CCEQ 1 "nonimmediate_operand" "y,r,r,x,y,r,m,r"))]
...
(define_expand "movv16qi"
  ...
  "
{
  if (mov_generic_vector_mode (operands))
    DONE;
}")

(define_expand "reload_inv"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(match_operand:V16QI 1 "any_operand" ""))
   (clobber (match_operand:SI 2 "gpc_reg_operand" "=&b"))]
  ""
  "
{
  if (GET_CODE (operands[1]) != CONST_VECTOR
    ...
    abort ();
  operands[1] = force_const_mem (VOIDmode, operands[1]);/* was V16QI */
...
;This pattern may not be needed.
;(define_expand "reload_outv16qi"
;  [(set (match_operand:V16QI 0 "any_operand" "")
...
(define_split
  [(set (mem:V16QI (plus:SI (match_operand:SI 0 "gpc_reg_operand" "")
			 (match_operand:SI 1 "short_cint_operand" "")))
	(match_operand:V16QI 2 "register_operand" ""))
   (clobber (match_operand:SI 3 "gpc_reg_operand" ""))]
  ""
  [(set (match_dup 3) (plus:SI (match_dup 0) (match_dup 1)))
   (set (mem:V16QI (match_dup 3))
	(match_dup 2))]
  "")

(define_insn ""
  [(set (mem:V16QI (plus:SI (match_operand:SI 0 "gpc_reg_operand" "b,r")
			 (match_operand:SI 1 "gpc_reg_operand" "r,b")))
	(match_operand:V16QI 2 "register_operand" "v,v"))]
  ""
  "@
   stvx %2,%0,%1
   stvx %2,%1,%0"
...
(define_insn ""
  [(set (mem:V16QI (match_operand:SI 0 "gpc_reg_operand" "r"))
	(match_operand:V16QI 1 "register_operand" "v"))]
  ""
  "stvx %1,0,%0"
  [(set_attr "type" "store")])
...
(define_split
  [(set (match_operand:V16QI 0 "register_operand" "")
	(mem:V16QI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "")
			 (match_operand:SI 2 "short_cint_operand" ""))))
   (clobber (match_operand:SI 3 "gpc_reg_operand" ""))]
  ""
  [(set (match_dup 3) (plus:SI (match_dup 1) (match_dup 2)))
   (set (match_dup 0)
	(mem:V16QI (match_dup 3)))]
  "")

(define_insn ""
  [(set (match_operand:V16QI 0 "register_operand" "=v,v")
	(mem:V16QI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "b,r")
			 (match_operand:SI 2 "gpc_reg_operand" "r,b"))))]
  ""
  "@
   lvx %0,%1,%2
   lvx %0,%2,%1"
  [(set_attr "type" "vec_load")])

(define_insn ""
  [(set (match_operand:V16QI 0 "register_operand" "=v")
        (mem:V16QI (match_operand:SI 1 "gpc_reg_operand" "r")))]
  ""
  "lvx %0,0,%1"
  [(set_attr "type" "vec_load")])

(define_insn "mov_vreg"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(match_operand:V16QI 1 "register_operand" "v"))]
  ""
  "* return choose_vec_easy (insn, \"vsldoi %0,%1,%1,0\", \"vor %0,%1,%1\");"
  [(set_attr "type" "vec_easy")])

(define_insn "vzero"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec:V16QI [(const_int 0)] 0))]
  ""
  "* return choose_vec_easy (insn, \"vspltisw %0,0\", \"vxor %0,%0,%0\");"
  [(set_attr "type" "vec_easy")])

(define_insn "vones"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec:V16QI [(const_int 0)] 1))]
  ""
  "* return choose_vec_easy (insn, \"vspltisw %0,-1\", \"vcmpequw %0,%0,%0\");"
  [(set_attr "type" "vec_easy")])

(define_insn "vone"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec:V16QI [(const_int 0)] 2))]
  ""
  "* return choose_vec_easy (insn, \"vspltisw %0,1\", \"vsubcuw %0,%0,%0\");"
  [(set_attr "type" "vec_easy")])

(define_insn "mov_from_vrsave"
  [(set (match_operand:SI 0 "register_operand" "=r")
	(unspec:SI [(const_int 0)] 16))]
  ""
  "mfspr %0,VRsave"
  [(set_attr "type" "*")
   (set_attr "length" "4")])
...
(define_insn ""
  [(match_parallel 0 "mov_to_vrsave_operation"
		   [(set (unspec_volatile:SI [(const_int 0)] 17)
...
;; dataflow will try to delete the store into it
...

; APPLE LOCAL begin AltiVec
;; AltiVec insns are next.

(define_expand "j_24_f_fxx_simple"
  [(parallel [(set (reg:CC 74)
		   (unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
			       (match_operand:V16QI 2 "register_operand" "v")
			       (match_operand 3 "any_operand" "")] 1))
	      (clobber (match_scratch:V16QI 4 "=v"))])
   (set (match_operand:SI 0 "register_operand" "=r")
	(lt:SI (reg:CC 74)
	       (const_int 0)))
...
(define_expand "j_24_f_fx_simple"
  [(parallel [(set (reg:CC 74)
		   (unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
			       (match_dup 1)
			       (match_operand 2 "any_operand" "")] 1))
...
(define_expand "j_24_f_frxx_simple"
  [(parallel [(set (reg:CC 74)
		   (unspec:CC [(match_operand:V16QI 2 "register_operand" "v")
			       (match_operand:V16QI 1 "register_operand" "v")
			       (match_operand 3 "any_operand" "")] 1))
	      (clobber (match_scratch:V16QI 4 "=v"))])
   (set (match_operand:SI 0 "register_operand" "=r")
...
(define_expand "j_24_t_fxx_simple"
  [(parallel [(set (reg:CC 74)
		   (unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
			       (match_operand:V16QI 2 "register_operand" "v")
			       (match_operand 3 "any_operand" "")] 1))
...
(define_expand "j_24_t_fx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
		    (match_dup 1)
		    (match_operand 2 "any_operand" "")] 1))
...
(define_expand "j_24_t_frxx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 2 "register_operand" "v")
		    (match_operand:V16QI 1 "register_operand" "v")
		    (match_operand 3 "any_operand" "")] 1))
...
(define_expand "j_26_f_fxx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
		    (match_operand:V16QI 2 "register_operand" "v")
		    (match_operand 3 "any_operand" "")] 1))
...
(define_expand "j_26_f_fx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
		    (match_dup 1)
		    (match_operand 2 "any_operand" "")] 1))
...
(define_expand "j_26_f_frxx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 2 "register_operand" "v")
		    (match_operand:V16QI 1 "register_operand" "v")
		    (match_operand 3 "any_operand" "")] 1))
...
(define_expand "j_26_t_fxx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
		    (match_operand:V16QI 2 "register_operand" "v")
		    (match_operand 3 "any_operand" "")] 1))
...
(define_expand "j_26_t_fx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 1 "register_operand" "v")
		    (match_dup 1)
		    (match_operand 2 "any_operand" "")] 1))
...
(define_expand "j_26_t_frxx_simple"
  [(parallel [(set (reg:CC 74)
	(unspec:CC [(match_operand:V16QI 2 "register_operand" "v")
		    (match_operand:V16QI 1 "register_operand" "v")
		    (match_operand 3 "any_operand" "")] 1))
...
(define_insn ""
  ...
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_simple")])

(define_insn "xfx_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (match_operand 2 "any_operand" "")] 1))]
  ""
  "%2 %0,%1"
  [(set_attr "type" "vec_perm")])

(define_insn "xfx_fp"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (match_operand 2 "any_operand" "")] 2))]
  ""
  "%2 %0,%1"
  [(set_attr "type" "vec_fp")])

(define_insn "xfA_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(match_operand:SI 1 "const_int_operand" "A")
		    (match_operand 2 "any_operand" "")] 3))]
  ""
  "%2 %0,%1"
  [(set_attr "type" "vec_perm")])

(define_insn "xfxx_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
...
(define_insn "xfxx_perm_bug"
  [(set (match_operand:V16QI 0 "register_operand" "=&v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (match_operand 3 "any_operand" "")] 5))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_perm")])
...
(define_insn "xfxx_fp"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (match_operand 3 "any_operand" "")] 2))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_fp")])

(define_insn "xfxx_complex"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (match_operand 3 "any_operand" "")] 3))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_complex")])

(define_insn "xfxx_simple"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (match_operand 3 "any_operand" "")] 4))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_simple")])

(define_insn "xfxB_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (match_operand:SI 2 "const_int_operand" "B")
		    (match_operand 3 "any_operand" "")] 6))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_perm")])
...
(define_insn "xfxB_fp"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (match_operand:SI 2 "const_int_operand" "B")
		    (match_operand 3 "any_operand" "")] 7))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_fp")])

(define_insn "xfxxx_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (use (match_operand:V16QI 3 "register_operand" "v"))
		    (match_operand 4 "any_operand" "")] 1))]
  ""
  "%4 %0,%1,%2,%3"
  [(set_attr "type" "vec_perm")])

(define_insn "xfxxx_fp"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (use (match_operand:V16QI 3 "register_operand" "v"))
		    (match_operand 4 "any_operand" "")] 2))]
  ""
  "%4 %0,%1,%2,%3"
  [(set_attr "type" "vec_fp")])

(define_insn "xfxxx_complex"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (use (match_operand:V16QI 3 "register_operand" "v"))
		    (match_operand 4 "any_operand" "")] 3))]
  ""
  "%4 %0,%1,%2,%3"
  [(set_attr "type" "vec_complex")])

(define_insn "xfxxx_simple"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (use (match_operand:V16QI 3 "register_operand" "v"))
		    (match_operand 4 "any_operand" "")] 4))]
  ""
  "%4 %0,%1,%2,%3"
  [(set_attr "type" "vec_simple")])

(define_insn "xfxxC_perm"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V16QI 1 "register_operand" "v"))
		    (use (match_operand:V16QI 2 "register_operand" "v"))
		    (match_operand:SI 3 "const_int_operand" "C")
		    (match_operand 4 "any_operand" "")] 5))]
  ""
  "%4 %0,%1,%2,%3"
  [(set_attr "type" "vec_perm")])

(define_insn "xfii_load"
  [(set (match_operand:V16QI 0 "register_operand" "=v,v,v")
	(unspec [(use (match_operand:SI 1 "reg_or_zero_operand" "b,O,r"))
		    (use (match_operand:SI 2 "reg_or_zero_operand" "r,r,O"))
		    (match_operand 3 "any_operand" "")] 8))]
  ""
  "@
   %3 %0,%1,%2
   %3 %0,0,%2
...
(define_insn "xlfii_load"
  [(set (match_operand:V16QI 0 "register_operand" "=v,v,v")
	(mem (unspec [(use (match_operand:SI 1 "reg_or_zero_operand" "b,O,r"))
			    (use (match_operand:SI 2 "reg_or_zero_operand" "r,r,O"))
			    (match_operand 3 "any_operand" "")] 9)))]
  ""
  "@
   %3 %0,%1,%2
   %3 %0,0,%2
...
(define_insn "sfxii_store"
  [(set (mem (unspec [(use (match_operand:SI 1 "reg_or_zero_operand" "b,O,r"))
			    (use (match_operand:SI 2 "reg_or_zero_operand" "r,r,O"))
			    (match_operand 3 "any_operand" "")] 10))
	(match_operand:V16QI 0 "register_operand" "v,v,v"))]
  ""
  "@
   %3 %0,%1,%2
   %3 %0,0,%2
...
(define_insn "vlfiiD_load"
  [(unspec_volatile [(use (match_operand:SI 0 "register_operand" "b"))
			(use (match_operand:SI 1 "register_operand" "r"))
			(match_operand:SI 2 "const_int_operand" "D")
			(match_operand 3 "any_operand" "")] 2)]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "load")])

(define_insn "vlfD_load"
  [(unspec_volatile [(match_operand:SI 0 "const_int_operand" "D")
			(match_operand 1 "any_operand" "")] 2)]
  ""
  "%1 %0"
  [(set_attr "type" "load")])

(define_insn "vlf_load"
  [(unspec_volatile [(match_operand 0 "any_operand" "")] 2)]
  ""
  "%0"
  [(set_attr "type" "load")])
...
(define_insn "vxf_fxu"
  [(set (match_operand:V16QI 0 "register_operand" "=v")
	(unspec_volatile [(match_operand 1 "any_operand" "")] 2))]
  ""
  "%1 %0"
...
(define_insn "vfx_fxu"
  [(unspec_volatile
    [(use (match_operand:V16QI 0 "register_operand" "v"))
     (match_operand 1 "any_operand" "")] 2)]
  ""
  "%1 %0"
  [(set_attr "type" "integer")])
...
; APPLE LOCAL begin AltiVec
(define_insn "*save_vregs_si"
 [(match_parallel 0 "any_operand"
                  [(clobber (match_operand:SI 1 "register_operand" "=l"))
		   (use (match_operand:SI 2 "call_operand" "s"))
		   (set (match_operand:V16QI 3 "any_operand" "=m")
...
; APPLE LOCAL begin AltiVec
;; see comments for *save_vregs_si
(define_insn "*return_and_restore_vregs_si"
 [(match_parallel 0 "any_operand"
                  [(return)
		   (use (match_operand:SI 1 "register_operand" "l"))
		   (use (match_operand:SI 2 "call_operand" "s"))
		   (clobber (match_operand:SI 3 "gpc_reg_operand" "=r"))
		   (set (match_operand:V16QI 4 "register_operand" "=v")
			(match_operand:V16QI 5 "any_operand" "m"))])]
 "TARGET_32BIT"
 "b %z2")

(define_insn "*restore_vregs_si"
 [(match_parallel 0 "any_operand"
                  [(clobber (match_operand:SI 1 "register_operand" "=l"))
		   (use (match_operand:SI 2 "call_operand" "s"))
		   (clobber (match_operand:SI 3 "gpc_reg_operand" "=r"))
...
; APPLE LOCAL begin AltiVec
;; <tur 13-01-2000> It looks like these patterns are for reversing the
;; sense of a test to cope with the fact that AltiVec only handles EQ or GT.
;; Added a "flag_altivec" test here 'cos I don't think this is correct for
;; non-vector cases.  This needs looking at!

(define_insn ""
  [(set (pc)
	(if_then_else (match_operator 0 "equality_operator"
				      [(match_operator:SI 1 "vector_comparison_operator"
							  [(match_operand:CC 2 "cc_reg_operand" "")
							   (const_int 0)])
				       (match_operand 3 "zero_m1_operand" "")])
		      (match_operand 4 "" "")
		      (match_operand 5 "" "")))]
  "flag_altivec && ((GET_CODE (operands[4]) != RETURN
 ...
 [(set (pc)
  ...
  [(set (pc)
	(if_then_else (match_dup 6)
		      ...
		      (match_dup 5)))]
  "
{ operands[6] = gen_rtx (GET_CODE (operands[1]), SImode, operands[2], const0_rtx);
  if ((GET_CODE (operands[0]) == EQ) == (INTVAL (operands[3]) == 0))
    {
      rtx tmp = operands[4];
...
;; APPLE LOCAL remove this so combine doesn't generate it
